...
<body>
        ...
        <main class="mx-auto grid max-w-6xl grid-cols-1 items-center gap-10 px-6 py-12 text-white md:grid-cols-[minmax(280px,380px)_minmax(0,1fr)] md:gap-16 md:px-10">
            ...
            <section class="max-w-2xl md:mt-4">
                ...
                <div class="mb-8 space-y-2 text-lg text-gray-300">
                    <p><span class="font-semibold text-white">Release date:</span> <?= htmlspecialchars($movie['release_date'] ?? '') ?></p>
                    <p><span class="font-semibold text-white">Rating:</span> <?= htmlspecialchars($movie['imd_rating'] ?? '') ?></p>
                </div>

                <h2 class="mb-4 text-2xl font-semibold text-white">Voorstellingen</h2>
    ...
    <?php else: ?>
        <main class="px-6 py-12 text-center text-white">
            <h1 class="text-3xl font-bold">Unknown Film</h1>
        </main>
    <?php endif; ?>
